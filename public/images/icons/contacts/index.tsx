...
interface IContactsProps extends ComponentProps<'svg'> {}

export const IContacts: FC<IContactsProps> = (props) => {
  return (
    <svg
      fill="#ffffff"
      viewBox="0 0 64 64"
...
export const StyledIContacts = styled(IContacts)`
  width: 36px;
  height: 36px;
`;
